...
If you have any questions or concerns about our privacy practices, please contact us at contact@flits.cc.
...
To exercise any of these rights, please contact us at contact@flits.cc. We may need to verify your identity before processing requests.
...
Parents or legal guardians who believe their child may have provided us with personal information can contact us at contact@flits.cc to request deletion and account closure.
...
We do not use cookies for tracking purposes on our website. However, our apps may use analytics technologies (such as SDKs) to understand how users interact with the app and to improve functionality. Some of our service providers may process data outside the European Economic Area (EEA). In such cases, we ensure appropriate safeguards are in place, such as Standard Contractual Clauses approved by the European Commission. However, we may employ third-party app-level tracking and analytics frameworks, including but not limited to the following:
...
We use analytics tools to better understand how users interact with our apps and to improve our services.

In particular, we use PostHog (PostHog Inc.) as our analytics provider.

PostHog may collect:

Usage data (e.g. app screens viewed, interactions, events)
...
We configure PostHog to avoid collecting personally identifiable information wherever possible.

The data is used solely for product improvement, debugging, and usage analysis. We process analytics data based on our legitimate interest in improving our services (Art. 6(1)(f) GDPR). Where required by law, we will obtain user consent before processing such data.
...
If you suspect a security issue or have discovered a vulnerability in our app, please report it immediately to contact@flits.cc.
...
If you are unsure whether a particular product or app falls under this Privacy Policy, you may refer to the app's listing on the App Store or contact us at contact@flits.cc for clarification.
