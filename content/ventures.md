...
| 03 | Access | Class access system for managing gated exercise and other class access. | Operating |
| 04 | Waterly | Water tracker app for logging hydration and building better drinking habits. | Operating |
| 05 | Stealth Ventures | Multiple Flits ventures are currently in stealth across B2C and B2B markets. | Stealth |
| 06 | CoronaWarn | App for checking the current COVID-19 rules at the user's location or elsewhere. | Wound down |
